...
/**
 * @file
 * Contains \Drupal\dcync_reg_links\Plugin\Block\RegLinksBlock.
 */
...
class RegLinksBlock extends BlockBase {
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $form['registration_link_text'] = array(
      '#type' => 'textfield',
    ...
    $form['sponsorship_link_text'] = array(
      '#type' => 'textfield',
  ...
  public function build() {
    ...
    $build['dcnyc_registration_links'] = array(
